import type { LicenseEntity, MarketplaceStore, ProductEntity, SellerEntity, TenantEntity } from "../dto/contracts.js";
...
const tenants: TenantEntity[] = [
  ...
  },
  {
    ...
    name: "Academy DAO",
    governanceStanding: "verified",
    federationTier: "federated",
    constitutionalStanding: "requires-review",
    treasuryLinked: true,
    operationalAuthority: "Academy Governance"
  },
  {
    ...
    constitutionalStanding: "requires-review",
    treasuryLinked: false,
    operationalAuthority: "ACS Review Queue"
  }
];

export function createMarketplaceSeed(now = new Date().toISOString()): MarketplaceStore {
  return {
    products,
    sellers,
    tenants,
    ...
    indexerSnapshots: [],
    governanceValidations: products.map((product) => ({
      id: `validation-${product.id}`,
      productId: product.id,
      standing: product.governanceStatus,
      requiredReviews: product.governanceRequired
        ? ["constitutional-review", "risk-review", product.nftBound ? "nft-ownership-readiness" : "license-review"]
        : [],
      blockers: product.governanceStatus === "restricted" ? ["restricted-until-acs-plugin-review"] : [],
      activationEnabled: false,
      settlementAllowed: false,
      createdAt: now
    })),
    governanceWorkflowActions: [],
    draftListings: [],
    deliveryPreviews: [],
    events: []
  };
